...
@section('content')
    ...
    <section class="my-10" id="appMuscic">
                        ...
                        <div class="flex">
                            <div class="w-full p-4">
                                ...
                                <div class="flex justify-between items-center mt-4">
                                    <div class="text-black p-3 rounded-full bg-gray-100 shadow">
                                    ...
                                    <div class="text-white p-4 rounded-full bg-red-300 shadow-lg">
                                        <svg class="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            ...
                            <div class="mt-1">
                                <div class="h-1 bg-gray-100 rounded-full">
                                    <div class="w-1/5 h-1 bg-red-300 rounded-full">
                                        <span class="w-4 h-4 bg-red absolute pin-r pin-b -mb-1 rounded-full shadow">
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center pb-3 border-b mb-4">
                                <div class="flex-1 flex flex-col">
                                    <a href="#">
                                        <span>Chapitre 1</span>
                                        <span
                                            class="font-serif font-bold font-black">---- </span>
                                    </a>
                                    <p> </p>
                                </div>
                                <div class="text-white p-4 rounded-full bg-red-300 shadow-lg ml-6">
