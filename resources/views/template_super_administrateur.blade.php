...
<!-- Mirrored from dashkit.goodthemes.co/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Jul 2020 12:09:07 GMT -->
<!-- Added by HTTrack -->
                            ...
                            <div class="col ml-n2">
                                ...
                                <form class="mt-1">
                                    <textarea class="form-control form-control-flush form-control"
                                              data-toggle="autosize" rows="1" placeholder="Leave a comment"></textarea>
                                </form>
                                ...
                                <div class="col ml-n2">
                                    ...
                                    <div class="comment-body">
                                        ...
                                        <p class="comment-text">
                                            ...
                                            think using a short looping video or something similar
                                ...
                                <li class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            ...
                                            <!-- Image -->
                                            <div class="avatar">
                                                <img class="avatar-img rounded" src="data:image/svg+xml,%3csvg3c/svg%3e"
                ...
                <li class="nav-item">
                    <a class="nav-link " href="docs/changelog.html">
                        <i class="fe fe-git-branch"></i> Changelog <span
                            class="badge badge-primary ml-auto">v1.6.0</span>
                    </a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropright">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="sidebarSmallPages">
                        ...
                        <li class="dropright">
                            <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallAccount" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Account
                            </a>
                        ...
                        <li class="dropright">
                            <a class="dropdown-item dropdown-toggle " href="#" id="sidebarSmallCrm" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                CRM
                            </a>
