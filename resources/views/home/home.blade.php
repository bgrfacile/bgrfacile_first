...
<path style="fill:#77D7ED;" d="M512,256c0,44.823-11.525,86.96-31.766,123.6c-7.239,13.113-15.6,25.515-24.938,37.085
    ...
    <section class="bg-gray-100">
        <div class="flex flex-wrap relative items-center">
            <div class="mx-auto mt-3 mb-auto w-5/6 sm:w-1/2 p-0 sm:p-4">
            ...
            <div class="mx-auto w-5/6 sm:w-1/2 p-0 sm:p-4">
    ...
    <section class="bg-gray-100 mb-12">
        <div class="flex flex-wrap items-center relative">
            <div class="order-2 md:order-1 mx-auto w-5/6 sm:w-1/2 p-0 sm:p-4">
                <img class="max-w-full h-auto overflow-hidden"
                     src="{{ asset('/assets/images/test2.jpg') }}"
                     alt="">
            </div>
            <div class="order-1 md:order-2 mx-auto mt-3 mb-auto w-5/6 sm:w-1/2 p-0 sm:p-4">
