...
@section('content')
    <section class="container mx-auto mb-20">
        <h3
            class="uppercase text-2xl font-bold mb-4 text-center">
        ...
        <div class="grid grid-cols-3 divide-x divide-gray-400 mx-auto max-w-6xl">
            <div class="px-10 mx-5 text-center ">
                <strong class="text-4xl count">12828959</strong>
                <p class="text-xl">Cours</p>
            </div>

            <div class="px-10 mx-5 text-center ">
                <strong class="text-4xl count">182959</strong>
                <p class="text-xl">Exercises et solutions</p>
            </div>

            <div class="px-10 mx-5 text-center ">
                <strong class="text-4xl count">12895</strong>
                <p class="text-xl">Astuces</p>
            </div>
        </div>
    </section>

    {{--    Etudiants--}}
    <section class="container w-3/4 mx-auto mb-20">
        <h2
        ...
        <p class="text-gray-600 mb-10">
            ...
            Cet espace est réservé aux apprenants, veuillez donc vous inscrire afin de nous permettre de mettre en votre disposition, ce qu’il faut pour votre apprentissage.
            Bgrfacile met à votre disposition, des cours, des exercices et solutions pour plus de compréhension et des astuces afin de facilités vos études.

        </p>
        <div class="flex justify-center mb-10 ext-gray-600">
            <div class="rounded-full h-16 w-16 p-2 flex items-center justify-center bg-gray-500">
                <img
                    class="w-full"
                    src="{{ asset('assets/images/crono.png') }}"
                    alt="">
            </div>
            <p class="w-full flex-1 pl-5">
                <strong class="text-bold text-blue-500">Astuces</strong> est réservé aux apprenants, veuillez donc vous inscrire afin de nous permettre de mettre en votre disposition, ce qu’il faut pour votre apprentissage. Bgrfacile met à votre disposition, des cours, des exercices et solutions pour plus de compréhension et des astuces afin de facilités vos études.
            </p>
        </div>
        <div class="flex justify-center mb-10 ext-gray-600">
            <div class="rounded-full h-16 w-16 p-2 flex items-center justify-center bg-gray-500">
    ...
    <section class="container w-3/4 mx-auto mb-20">
        ...
        <p class="text-gray-600 mb-10">
            Chers professeurs prenez le soin de vous inscrire afin de permettre de mieux classer votre contenue bgrfacile vous donne la possibilité de dispenser vos cours en ligne, de mettre en valeur votre savoir-faire.
        </p>
        <div class="flex justify-center mb-10 ext-gray-600">
            <div class="rounded-full h-16 w-16 p-2 flex items-center justify-center bg-gray-500">
                <img
        ...
        <div class="flex flex-wrap">
            <div class="w-full sm:w-1/2 p-6">
                ...
                <p class="text-gray-600 mb-8">
                    Seules les écoles enregistrées sont affichées sur la plateforme.
                    N’oubliez donc pas de vous abonner sur notre plateforme pour faciliter l’interaction avec vos étudiants, vos professeurs, et de mettre en avant les bienfondés de votre établissement.
                    <br><br>
                    <button
