    ...
    <style>
        @media (min-width: 1024px) {
            .vs-bg-courses {
                ...
                background-image: url("{{ asset('assets/svg/draw_etudiant.svg') }}");
                background-size: 45%;
            }
        }
        ...
        <div class="max-w-6xl mx-auto pt-10 px-5 md:px-10 md:pt-32 lg:px-0">
            <div class="md:w-1/2 xl:w-7/12">
                <div>
                    ...
                    <img data-src="{{ asset('assets/svg/draw_etudiant.svg') }}" class="mb-8 md:hidden lazyLoad">
                    <div>
                ...
                <div class="hidden pt-10 pb-14 lg:pt-20 md:flex lg:mr-32">
                    <div
                        ...
                        style="background-color: rgb(83, 162, 255);">
                        <a href="#"
                    ...
                    <div
                        class="flex-1 h-18 text-white text-3xs uppercase font-medium justify-center flex items-center text-center px-4 rounded-lg mx-1 lg:text-sm lg:mx-2"
                        style="background-color: rgb(67, 213, 117);">
                        <a href="#">
                            Cours
                        </a>
                    </div>
                    <div
                        class="flex-1 h-18 text-white text-3xs uppercase font-medium justify-center flex items-center text-center px-4 rounded-lg mx-1 lg:text-sm lg:mx-2"
                        style="background-color: rgb(174, 100, 243);">
                        <a href="#">
                            Exercices
                        </a>
                    </div>
                    <div
                        class="flex-1 h-18 text-white text-3xs uppercase font-medium justify-center flex items-center text-center px-4 rounded-lg mx-1 lg:text-sm lg:mx-2"
                        style="background-color: rgb(243, 132, 84);">
                        <a href="#">
                            Corrigés
                        </a>
                    </div>
        ...
        <div class="max-w-6xl mx-auto pt-10 px-5 md:px-10 md:pt-32 lg:px-0">
            <div class="md:w-1/2 xl:w-7/12">
                <div>
                    ...
                    <div
                        class="text-center text-lg font-medium mb-5 leading-relaxed md:text-xl md:text-base md:text-left md:mb-10 lg:text-lg">
                        En plus de toutes les fonctionnalités déja cité pour un étudiant, bgrfqcile offre plus au professeurs décirant mettre du contenue sur le site.
                    </div>
        ...
        <div class="flex flex-wrap flex-col md:flex-row items-center relative">
            <div class="mt-3 mb-auto w-full sm:w-1/2 p-2 sm:p-4">
                ...
                <p class="text-gray-600 mb-8">
                    Si vous faites partie d'une écoles, bgrfacile vous offre la possibilité d'intéragir directement avec la direction de cette école.Comment? je vous invite à le découvir dans la section école.
                    <br>
            ...
            <div class="mx-auto w-full sm:w-1/2 p-2 sm:p-4">
                <img class="max-w-full h-auto overflow-hidden"
                     src="{{ asset('assets/images/dotnet-visual-studio.gif') }}">
            </div>
        </div>
    </section>
