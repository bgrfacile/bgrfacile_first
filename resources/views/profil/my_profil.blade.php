...
@section('content')
    ...
    <div class="py-5">
        ...
        <div class="grid col-span-1 md:flex items-center mt-5 justify-center">
            ...
            <div class="md:border-l-2 pl-4 p-2 col-span-2 text-justify md:w-1/2 mt-10 md:mt-0">
                <h4>
                    ...
                    <span class="font-bold capitalize">{{ $user->prenom }}</span>
                </h4>
                <p class="mt-4">
                    {{ $user->bio }}
                </p>
        ...
        <div class="grid col-span-1 md:flex items-center mt-5 justify-center text-center">
            <div>
                @if($user->bio == '')
                    <div class="mb-2">Votre profil est incomplete. Merci de complete votre profil</div>
        ...
        <div class="grid col-span-1 md:flex items-center mt-5 justify-center">
            ...
            {{--            <div class="pl-4 p-2 col-span-2 text-justify md:w-1/2 mt-10 md:mt-0">--}}
            {{--                <div class="flex flex-col bg-white rounded p-4 items-center shadow-lg border-t-8 border-red-400 mb-4 md:mb-auto">--}}
    ...
    {{--                        <svg class="svg-inline--fa fa-envelope-open-text fa-w-16 fa-2x mr-2" aria-hidden="true"--}}
    {{--                             focusable="false" data-prefix="fas" data-icon="envelope-open-text" role="img"--}}
    ...
    {{--                        </svg><!-- <i class="fas fa-envelope-open-text fa-2x mr-2"></i> Font Awesome fontawesome.com -->--}}
    {{--                        <p>matias@icodeart.cl</p>--}}
    {{--                    </div>--}}

    {{--                    <div class="flex items-center">--}}
    {{--                        <svg class="svg-inline--fa fa-github fa-w-16 fa-2x mr-2" aria-hidden="true" focusable="false"--}}
    ...
    {{--                        </svg><!-- <i class="fab fa-github fa-2x mr-2"></i> Font Awesome fontawesome.com -->--}}
    ...
    {{--                        <svg class="svg-inline--fa fa-phone-alt fa-w-16 fa-2x mr-2 mb-4 md:mb-0" aria-hidden="true"--}}
    {{--                             focusable="false" data-prefix="fas" data-icon="phone-alt" role="img"--}}
    {{--                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">--}}
    {{--                            <path fill="currentColor"--}}
    {{--                                  d="M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"></path>--}}
    {{--                        </svg>--}}
    {{--                        <!-- <i class="fas fa-phone-alt fa-2x mr-2 mb-4 md:mb-0"></i> Font Awesome fontawesome.com -->--}}
    {{--                        <p>+5 6 9 3 2 6 8 8 8 2 4 </p>--}}
    {{--                    </div>--}}

    {{--                    <div class="flex items-center">--}}
    {{--                        <svg class="svg-inline--fa fa-globe fa-w-16 fa-2x mr-2" aria-hidden="true" focusable="false"--}}
    ...
    {{--                        </svg><!-- <i class="fas fa-globe fa-2x mr-2"></i> Font Awesome fontawesome.com -->--}}
    {{--                        <p> icodeart.cl</p>--}}
    {{--                    </div>--}}
    {{--                </div>--}}
    {{--            </div>--}}
